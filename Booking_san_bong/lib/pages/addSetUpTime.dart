...
class AddSetUpTimePage extends StatefulWidget {
  @override
  _AddSetUpTimePageState createState() => _AddSetUpTimePageState();
}

class _AddSetUpTimePageState extends State<AddSetUpTimePage> {
  @override
            ...
            children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Wrap(
                          ...
                          children: <Widget>[
                            ...
                            // buttonSample(
                            //     "Đã đặt", UIData.mainColor, Colors.white),
                            buttonSample(
                                "🔒", Colors.grey[300], Colors.black54),
                          ],
                        ),
                      ),
                      SizedBox(height: 10),
                      ...
                      Container(
                        ...
                        child: Wrap(
                          ...
                          children: <Widget>[
                            ...
                            buttonTime("7:10 - 8:40 AM", Colors.white,
                                Colors.black54),
                            buttonTime("9:20 - 10:50 PM", Colors.white,
                                Colors.black54),
                            buttonTime("13:00 - 14:30 PM",Colors.white ,
                             Colors.black54),
                            buttonTime("15:10 - 16:40 PM", Colors.white,
                                Colors.black54),
                            buttonTime("17:20 - 18:50 PM", Colors.white,
                                Colors.black54),
                            buttonSample("🔒", Colors.grey[300],
                                Colors.black54),
                            buttonSample("🔒", Colors.grey[300],
                                Colors.black54),
                          ],
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    FlatButton(
                        color: Color.fromARGB(255, 216, 103, 83),
                        shape: RoundedRectangleBorder(
